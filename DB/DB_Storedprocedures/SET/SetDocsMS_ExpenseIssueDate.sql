CREATE OR REPLACE FUNCTION transportation_expense_bot."SetDocsMS_ExpenseIssueDate"(_user_address VARCHAR, _docs_id INT, _expense_issue_date DATE)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN			-- Exec part
	...
	SET "EXPENSE_ISSUE_DATE" = _expense_issue_date
